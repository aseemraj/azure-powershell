...
namespace Microsoft.Azure.Commands.SiteRecovery
{
    ...
    public class ASRPolicy
    {
        ...
        public ASRPolicy(Policy policy)
        {
            ...
            if (policy.Properties.ProviderSpecificDetails is HyperVReplicaBluePolicyDetails)
            {
                ...
                replicationProviderSettings.OnlineReplicationStartTime = TimeSpan.Parse(details.OnlineReplicationStartTime);
            ...
            else if (policy.Properties.ProviderSpecificDetails is HyperVReplicaAzureReplicationDetails)
            {
    ...
    public class ASRTaskBase
    {
        ...
        public ASRTaskBase(Management.SiteRecovery.Models.ASRTask taskBase)
        {
    ...
    public class ASRTask
    {
        ...
        /// </summary>
        /// <param name="task">Task details to load values from.</param>
        public ASRTask(Management.SiteRecovery.Models.ASRTask task)
        {
            this.ID = task.Name;
